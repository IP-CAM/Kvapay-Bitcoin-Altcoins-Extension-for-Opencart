...
class ControllerPaymentKvapay extends Controller
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('payment/kvapay/checkout', true);

        return $this->load->view('default/template/payment/kvapay.tpl', $data);
    }
    ...
    public function checkout()
    {
        ...
        $this->load->model('checkout/order');
        $this->load->model('payment/kvapay');
        ...
        $params = [
            ...
            'failUrl' => $this->url->link('payment/kvapay/cancel', '', true),
            'successUrl' => $this->url->link('payment/kvapay/success', array('cg_token' => $token), true),
            'timestamp' => time(),
